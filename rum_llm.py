...
STORE_DIR= "starcoder-1b-lora-test"  

SEQ_LENGTH = 2048  # Sequence length

# Training arguments
MAX_STEPS = 200  # max_steps
VALIDATION_SIZE = 4000  # validation_size
...
training_args = TrainingArguments(
    ...
    eval_strategy="steps", # evaluate every EVAL_FREQ steps
    save_strategy="steps", # save every SAVE_FREQ steps
